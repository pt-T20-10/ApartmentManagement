...
-- Tắt kiểm tra khóa ngoại để tránh lỗi khi nạp dữ liệu chéo
SET FOREIGN_KEY_CHECKS = 0;

-- =================================================================
-- PHẦN 2: TẠO BẢNG (TABLES) THEO ĐÚNG THỨ TỰ
-- =================================================================

-- 1. Users (Độc lập - Dùng cho Building Manager)
CREATE TABLE `users` (
...
CREATE TABLE `buildings` (
  ...
  FOREIGN KEY (`manager_user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 7. Contracts (Phụ thuộc Apartments, Residents)
CREATE TABLE `contracts` (
  `id` bigint NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `contract_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mã số hợp đồng',
...
-- 8. Contract History (Phụ thuộc Contracts)
...
-- 9. Contract Services (Phụ thuộc Contracts, Services)
...
-- 10. Household Members (Phụ thuộc Contracts)
...
-- 11. Service Usage (Phụ thuộc Contracts, Services)
...
-- 12. Invoices (Phụ thuộc Contracts)
...
-- 13. Invoice Details (Phụ thuộc Invoices)
...
-- =================================================================
-- PHẦN 3: NẠP DỮ LIỆU (INSERT DATA)
-- =================================================================
...
(1, 'admin', '$2a$12$rv25rteDm0zwLBExcSx2Su72F7YUKHoLagkzUPUWtS5X8.JAleBfK', 'Administrator', 'ADMIN', 1, '2026-01-13 08:05:08', '2026-01-27 03:36:10'),
(3, 'staff', '$2a$12$rKM16ZrP7OiO9I438pFoJOqleM6ZgNyctVMljK8MdYWP71gu06NYG', 'Staff Member', 'STAFF', 1, '2026-01-13 09:03:05', '2026-01-26 12:32:38'),
(4, 'accountant', '$2a$12$Hd.KGAHL9lHV3a6PFh9Ul.Nhk1HZPNjYd..qHoP.nxWPU7gsOEoEW', 'Accountant', 'ACCOUNTANT', 1, '2026-01-13 09:03:05', '2026-01-13 09:08:35');

-- =================================================================
-- PHẦN 4: PROCEDURES & TRIGGERS (ĐÃ BỎ DEFINER ĐỂ TRÁNH LỖI)
-- =================================================================
...
BEGIN
    ...
    SELECT IFNULL(MAX(CAST(SUBSTRING(contract_number, 12, 3) AS UNSIGNED)), 0) + 1
    INTO next_seq
