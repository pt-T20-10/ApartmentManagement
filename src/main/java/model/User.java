...
/**
 * User Entity
 * Represents a user account in the system with hierarchical permissions
 * 
 * Roles:
 * - ADMIN: System administrator (full access to all buildings)
 * - MANAGER: Building manager (manages one building and its staff)
 * - STAFF: Building staff (works at assigned building, handles residents/contracts/invoices)
 */
public class User {
     ...
     * MANAGER/STAFF chỉ access building được gán.
     */
