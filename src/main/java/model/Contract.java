 ...
 * UPDATED: Enhanced logic for RENTAL vs OWNERSHIP contracts
 * 
 * RENTAL (Thuê):
 * - Has: signed_date, start_date, end_date
 * - Price: monthly_rent (tiền thuê/tháng)
 * - Can be: renewed, terminated
 * 
 * OWNERSHIP (Sở hữu):
 * - Has: signed_date ONLY (no start/end dates)
 * - Price: monthly_rent (giá mua - total purchase price)
 * - Cannot be: renewed (permanent ownership)
 * - Can be: terminated (in special cases)
 */
public class Contract {
    ...
    public Date getTerminatedDate() { return terminatedDate; }
    public void setTerminatedDate(Date terminatedDate) { this.terminatedDate = terminatedDate; }
     ...
     * Only RENTAL contracts can be renewed
     */
