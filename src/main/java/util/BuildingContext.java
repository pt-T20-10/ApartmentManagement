...
/**
 * Building Context Manager (Singleton)
 * Quản lý context hiện tại: Building → Floor → Apartment
 * 
 * Dùng để các tab khác (Cư Dân, Hợp Đồng...) biết được
 * user đang xem tòa nhà/tầng/căn hộ nào
 */
