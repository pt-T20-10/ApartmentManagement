...
/**
 * BuildingDAO - UPDATED Phase 3
 * Added building filter for MANAGER role
 */
public class BuildingDAO {
    ...
    /**
     * Get all buildings with building filter
     * UPDATED: Phase 3 - MANAGER only sees their building
     */
    ...
    /**
     * Get all buildings with user filter
     * NEW: Phase 3
     */
