...
public class ApartmentDAO {
    ...
    public List<Apartment> getAllApartments() {
        ...
        try (Connection conn = Db_connection.getConnection();
            ...
            while (rs.next()) apartments.add(mapResultSetToApartment(rs));
    ...
    public int countApartmentsByBuilding(Long buildingId) {
        ...
        try (Connection conn = Db_connection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            if(buildingId != null) ps.setLong(1, buildingId); else return countApartments();
    ...
    public int countAvailableApartmentsByBuilding(Long buildingId) {
        ...
        try (Connection conn = Db_connection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            if(buildingId != null) ps.setLong(1, buildingId); else return countAvailableApartments();
            try (ResultSet rs = ps.executeQuery()) { if (rs.next()) return rs.getInt(1); }
        } catch (SQLException e) { e.printStackTrace(); }
        return 0;
    }
    ...
    public int countRentedApartmentsByBuilding(Long buildingId) {
        ...
        try (Connection conn = Db_connection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            if(buildingId != null) ps.setLong(1, buildingId); else return countRentedApartments();
            try (ResultSet rs = ps.executeQuery()) { if (rs.next()) return rs.getInt(1); }
        } catch (SQLException e) { e.printStackTrace(); }
        return 0;
    }
