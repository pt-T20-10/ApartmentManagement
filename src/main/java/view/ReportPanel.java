...
/**
 * Enhanced Report Panel with Professional Charts
 * ✨ 5 Comprehensive Reports:
 * 1. Revenue Report (Line + Bar Charts)
 * 2. Invoice & Debt Report (Donut + Bar Charts)
 * 3. Service Revenue Report (Pie + Bar Charts)
 * 4. Apartment & Contract Report (Progress + Gauge)
...
public class ReportPanel extends JPanel {
    ...
    private JPanel createFilterPanel() {
        ...
        for (int i = 1; i <= 12; i++) fromMonthCombo.addItem(i);
        ...
        for (int i = 1; i <= 12; i++) toMonthCombo.addItem(i);
        ...
        for (int i = currentYear - 3; i <= currentYear; i++) yearCombo.addItem(i);
