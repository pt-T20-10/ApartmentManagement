...
public class ApartmentDialog extends JDialog {
    ...
    private void initUI() {
        ...
        ((AbstractDocument) txtArea.getDocument()).setDocumentFilter(new DocumentFilter() {
            @Override public void insertString(FilterBypass fb, int offset, String s, AttributeSet a) throws BadLocationException { 
                if (s.matches("[0-9.]*")) super.insertString(fb, offset, s, a); 
            }
            @Override public void replace(FilterBypass fb, int offset, int l, String t, AttributeSet a) throws BadLocationException { 
                if (t.matches("[0-9.]*")) super.replace(fb, offset, l, t, a); 
            }
        });
